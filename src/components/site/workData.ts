import { Building2, Code2, ServerCog, ShoppingCart, Smartphone, type LucideIcon } from "lucide-react";
...
const portfolioProjects = [
  {
    ...
    "description": "A full-stack Laravel 10 backend and API platform powering a multi-vendor ecommerce web app plus three mobile apps for vendors, customers, and delivery operations.",
    "thumbnail": "/work-images/wikifood.webp",
    "images": [
      "/work-images/wikifood.webp"
    ],
    "stack": [
      "Laravel 10",
      "PHP 8.2",
    ...
    "type": "Mobile product",
    "summary": "A full-stack Laravel 10 backend and API platform powering a multi-vendor ecommerce web app plus three mobile apps for vendors, customers, and delivery operations.",
    ...
    "detailIntro": "A full-stack Laravel 10 backend and API platform powering a multi-vendor ecommerce web app plus three mobile apps for vendors, customers, and delivery operations.",
    "challenge": "Built and maintained modules for orders, sub-orders, POS workflows, products, vendors, customers, deliverymen, warehouses, stock, coupons, campaigns, banners, advertisements, subscriptions, wallets, disbursements, reports, and tax/VAT operations. The API layer supports authentication, cart, checkout, order tracking, wallet flows, loyalty points, notifications, chat, reviews, location tracking, and delivery status updates across the mobile and web ecosystem.",
    "build": "Implemented admin and vendor POS workflows with item-level percentage discounts, purchase-price validation, tax recalculation, order editing, and stock-safe order placement. Enhanced order management with parent/sub-order tracking, cancellation APIs, stock restoration, inline filters, pagination, scroll memory, receipt hash updates, and accurate parent-order totals.",
    "impact": "Added promotional systems for store, category, and item advertisements, redirect metadata, campaigns, flash sales, cashback, coupons, banners, and global brand support. Improved catalog management with bulk actions, product galleries, brand filtering, warehouse stock handling, always-in-stock logic, variations, add-ons, suppliers, units, attributes, and product approval flows. Built activity logging, role/module permissions, admin access control, exports, wallet transactions, withdrawal methods, deliveryman earnings, and tax reports.",
    "modules": [
      "Laravel 10",
      "PHP 8.2",
      "MySQL",
  ...
  },
  {
    ...
    "description": "A Laravel 10 REST API backend for an online printing and delivery platform connecting clients, admins, vendors, and delivery drivers through separate app modules.",
    "thumbnail": "/work-images/printoutt.webp",
    "images": [
      "/work-images/printoutt.webp"
    ],
    "stack": [
      "Laravel 10",
      "PHP",
    ...
    "summary": "A Laravel 10 REST API backend for an online printing and delivery platform connecting clients, admins, vendors, and delivery drivers through separate app modules.",
    ...
    "detailIntro": "A Laravel 10 REST API backend for an online printing and delivery platform connecting clients, admins, vendors, and delivery drivers through separate app modules.",
    "challenge": "Built REST APIs for the client app, admin dashboard, vendor portal, and delivery app. Implemented multi-guard JWT authentication for clients, admins, vendors, and delivery users, with OTP verification through email/SMS, password reset, social login, and FCM token handling.",
    "build": "Developed custom print flows for documents, banners, uploaded files, PDFs, images, and Google Drive links. Implemented dynamic pricing for paper type, size, quantity, pages, selected page ranges, banner dimensions, materials, and customizations. Built cart and checkout systems for authenticated users and guests using guest tokens.",
    "impact": "Used Spatie Media Library for file/media management, Spatie Permissions for roles and permissions, and Laravel localization for multilingual catalog data. Added unit tests for PDF validation, PDF configuration, upload limits, and structured PDF error handling.",
    "modules": [
      "Laravel 10",
      "PHP",
      "MySQL",
  ...
  },
  {
    ...
    "description": "A full-stack AI event photography platform with a Laravel API backend and a Next.js admin dashboard for events, media workflows, payments, analytics, moderation, and permissions.",
    "thumbnail": "/work-images/taggz.webp",
    "images": [
      "/work-images/taggz.webp"
    ],
    "stack": [
      "Laravel 13",
      "PHP 8.3",
    ...
    "type": "Backend platform",
    "summary": "A full-stack AI event photography platform with a Laravel API backend and a Next.js admin dashboard for events, media workflows, payments, analytics, moderation, and permissions.",
    ...
    "detailIntro": "A full-stack AI event photography platform with a Laravel API backend and a Next.js admin dashboard for events, media workflows, payments, analytics, moderation, and permissions.",
    "challenge": "Developed the Laravel backend API with Sanctum authentication, role-based permissions, AI photo processing workflows, payment integrations, and scalable media upload infrastructure. Built RESTful APIs for authentication, social login, OTP email verification, password reset, user profiles, account management, Firebase push notifications, notification preferences, support issues, and device token management.",
    "build": "Implemented event management with public/private events, hosts, co-hosts, moderators, invitations, ownership transfer, QR/code joining, attendee check-in, and event groups. Developed advanced photo workflows including direct uploads, batch uploads, multipart uploads, ZIP uploads, resumable tus uploads, folders, favorites, reports, share links, and download tracking.",
    "impact": "Implemented photo management with upload monitoring, photo detail pages, lightbox viewing, favorites, deletion, retry flows, moderation reporting, and tus upload support. Built member management, package tiers, pricing rules, upgrade requests, inquiries, expiry views, billing console tabs, KPI cards, charts, revenue analytics, event metrics, photo metrics, audit logs, payment transactions, subscriptions, payout views, Telegram/admin notification settings, and admin subscription rules.",
    "modules": [
      "Laravel 13",
      "PHP 8.3",
      "Sanctum",
  ...
  },
  {
    ...
    "description": "A cross-platform React Native booking marketplace for horse riding experiences in Egypt, connecting riders with stables, horses, events, schools, and photographers.",
    "thumbnail": "/work-images/jawad.webp",
    "images": [
      "/work-images/jawad.webp"
    ],
    "stack": [
      "React Native",
      "TypeScript",
    ...
    "type": "Mobile product",
    "summary": "A cross-platform React Native booking marketplace for horse riding experiences in Egypt, connecting riders with stables, horses, events, schools, and photographers.",
    ...
    "detailIntro": "A cross-platform React Native booking marketplace for horse riding experiences in Egypt, connecting riders with stables, horses, events, schools, and photographers.",
    "challenge": "Developed the iOS and Android app for discovering, booking, and managing horse riding experiences, events, schools, and photography sessions. Built client login, registration, OTP, password reset, Apple Sign-In, Google Sign-In, guest browsing, profile editing, contact us, terms/about pages, booking history, booking details, and saved/favorite horse flows.",
    "build": "Implemented multi-role authentication for clients, stable owners, photographers, and schools, with role-based navigation and dashboards. Built booking flows for horses, events, and photo sessions, including cart management, coupons, checkout steps, payment WebView integration, refund/check booking status flows, and deep linking to booking history and horse details.",
    "impact": "Added bilingual Arabic/English localization with RTL support, dynamic language switching, localized onboarding/content, Firebase push notification token handling, and persistent auth/session storage. Worked on native iOS App Store readiness, including App Intents/deep links, URL schemes, simulator builds, CocoaPods, Android Gradle, and App Store review journey preparation.",
    "modules": [
      "React Native",
      "TypeScript",
      "React Navigation",
  ...
  },
  {
    ...
    "href": "",
    "description": "A highly sophisticated, enterprise-grade e-commerce and logistics backend built on the Laravel ecosystem. Expertly handles multi-leveled product taxonomy, complex logistics, scalable API architectures, and real-time data processing.",
    "thumbnail": "/work-images/elnasserback.webp",
    "images": [
      "/work-images/elnasserback.webp"
    ],
    "stack": [
      "Laravel",
      "PHP",
    ...
    "type": "Backend platform",
    "summary": "A highly sophisticated, enterprise-grade e-commerce and logistics backend built on the Laravel ecosystem. Expertly handles multi-leveled product taxonomy, complex logistics, scalable API architectures, and real-time data processing.",
    "scope": "Laravel, PHP",
    ...
    "detailIntro": "A highly sophisticated, enterprise-grade e-commerce and logistics backend built on the Laravel ecosystem. Expertly handles multi-leveled product taxonomy, complex logistics, scalable API architectures, and real-time data processing.",
    "challenge": "- Database & Query Optimization: Re-engineered the category system to move away from rigid 2-level nested loops to infinite-depth traversal using WITH RECURSIVE SQL CTEs. Implemented cache invalidation strategies using tree-version mechanics with Laravel Cache. Managed zero-downtime database schema upgrades for large datasets. - Background Jobs & Queue Processing: Real-time Trash System and Bulk Delete implementations running via Laravel Queues. Handlers softly delete nested subcategories recursively and flush storage/cache. UI maintains live interactivity using AJAX polling. - Comprehensive API Layer: Microservices-influenced separation using strict headers. Token-based auth via Bearer Tokens, secure password storage, and Multi-Factor/OTP. Robust Postman Collections integration dynamically exported via custom Artisan commands.",
    "build": "- Advanced Recursive Category Architecture: Unlimited subcategory levels allowing complex taxonomies. Implemented descendant/ancestor lookups using SQL CTEs. Deep API endpoints return nested tree JSON structures up to specific depths. - Category Groups API: Admin customizable \"Groups\" for dynamic storefront features, allowing carousels containing categories and products natively with level type mapping embedded in API responses. - Mobile App V1 API Expansion: Full checkout capability, offline payments via multipart/form-data with up to 5MB screenshot uploads, campaign tracking, and robust filtering rules for items intercepting dynamic query scopes. New checkout summary engine computes live projections for coupons and loyalty points. - Delivery Man Ecosystem & Payroll Engine: Completely functional dispatch and delivery portal. Solved critical visibility bugs for non-vehicular constrained orders. Internal delivery teams earn base monthly salaries plus task commissions while freelancers earn dynamic commissions. Engineered Delivery Fee APIs simulating costs based on distance, volumetric weight, and vehicle mappings. - Delivery & Payment Admin Reports: Dedicated reporting interfaces for delivery operations powered by Eloquent Scopes to resolve complex SQL ambiguity. Devised advanced Seeders demonstrating operational behavior logical flows. - Customer Loyalty, Tiers, & Referral Setup: Automated tiered setups (Bronze, Silver, Gold). End-to-end payload routing dynamically pushes user preferences configuration directly to the settings vault. Integrated helper logic calculating validation tokens natively at the payload layer without persistent coupon entities. Rigorous PHPUnit testing sequence to validate the calculations. - SMS OTP Authentication Protocol: Frictionless phone-based onboarding. Tri-state workflow handler mapping logic into new, old, and existing states seamlessly without premature auth token issuance. - Frontend Images & Dashboard Theme Overrides: System-wide native theme handling supporting layout partial overrides. Devilled an intelligent CSS pyramid grid engine visualizing category structures depending on recursive depth calculations. Dedicated UI bridging image payload storage dynamically. - Admin Tools & Python Automation: Orchestrated python helpers alongside PHP loops (seed_products.py, fetch_product_images.py, cleanup_category_images.py) destroying orphaned blobs, handling mass api integration (Pixabay), and processing raw file dumps efficiently.",
    "impact": "Operating as the Lead Backend & DevOps Engineer, I architected this massive Laravel backend to scale. My work heavily centered on advanced database engineering, scalable API designs, caching, seamless queuing algorithms, and comprehensive DevOps pipeline optimizations.",
    "modules": [
      "Laravel",
      "PHP",
      "MySQL",
  ...
  },
  {
    ...
    "description": "A high-performance, modern landing page serving as the primary digital storefront for Al Nasser, a prominent retail brand with over 52 branches in Egypt and Kuwait. Designed to balance impression-driven brand storytelling with conversion optimization.",
    "thumbnail": "/work-images/alnasser.webp",
    "images": [
      "/work-images/alnasser.webp"
    ],
    "stack": [
      "React 18",
      "TypeScript",
    ...
    "summary": "A high-performance, modern landing page serving as the primary digital storefront for Al Nasser, a prominent retail brand with over 52 branches in Egypt and Kuwait. Designed to balance impression-driven brand storytelling with conversion optimization.",
    ...
    "detailIntro": "A high-performance, modern landing page serving as the primary digital storefront for Al Nasser, a prominent retail brand with over 52 branches in Egypt and Kuwait. Designed to balance impression-driven brand storytelling with conversion optimization.",
    "challenge": "My Role & Implementation: I architected and built the entire front-end of this project from scratch using React 18, establishing our team's first step into level-A corporate systems. I strictly enforced performance best practices-utilizing React.memo, aggressive code splitting for below-the-fold content via Suspense, and modern asset optimizations-resulting in a flawless 100/100 performance and SEO score across all Google Lighthouse tests.",
    "build": "Project Status & Scale: This successfully completed Phase One serves a brand with 2+ million active cross-platform followers. It anchors the ecosystem before the rollout of the full e-commerce module, management dashboard, and mobile applications.",
    "impact": "Project Status & Scale: This successfully completed Phase One serves a brand with 2+ million active cross-platform followers. It anchors the ecosystem before the rollout of the full e-commerce module, management dashboard, and mobile applications.",
    "modules": [
      "React 18",
      "TypeScript",
      "Vite",
  ...
  },
  {
    ...
    "description": "A modern, high-performance two-sided marketplace designed to bridge the gap between Brands and UGC creators/Influencers. Engineered with React Router v7 and TypeScript, it features complex multi-tenant onboarding flows and integrated ROI analytics.",
    "thumbnail": "/work-images/igc.webp",
    "images": [
      "/work-images/igc.webp",
      "/work-images/igc2.webp"
    ],
    "stack": [
      "React Router v7",
      "TypeScript",
    ...
    "summary": "A modern, high-performance two-sided marketplace designed to bridge the gap between Brands and UGC creators/Influencers. Engineered with React Router v7 and TypeScript, it features complex multi-tenant onboarding flows and integrated ROI analytics.",
    ...
    "detailIntro": "A modern, high-performance two-sided marketplace designed to bridge the gap between Brands and UGC creators/Influencers. Engineered with React Router v7 and TypeScript, it features complex multi-tenant onboarding flows and integrated ROI analytics.",
    "challenge": "Architectural Highlights: - SSR & Performance: Built on React Router v7 (formerly Remix) for superior SEO and faster First Contentful Paint. - Modular Logic: Utilizes Zustand for lightweight state management and custom React Contexts for complex global workflows. - Sophisticated UI: High-performance micro-animations powered by Framer Motion and responsive layouts via Tailwind CSS.",
    "build": "My Role & Implementation: As the Lead Front-End Developer, I was responsible for transforming complex Figma designs into a high-performance, responsive UI. I architected the front-end structure using React Router v7, integrated all API endpoints, and ensured a seamless, type-safe data flow across the dual-persona marketplace.",
    "impact": "My Role & Implementation: As the Lead Front-End Developer, I was responsible for transforming complex Figma designs into a high-performance, responsive UI. I architected the front-end structure using React Router v7, integrated all API endpoints, and ensured a seamless, type-safe data flow across the dual-persona marketplace.",
    "modules": [
      "React Router v7",
      "TypeScript",
      "Tailwind CSS",
  ...
  },
  {
    ...
    "description": "A premium, highly interactive corporate web platform for a leading contracting company in Saudi Arabia. Built to showcase civil engineering capabilities and large-scale infrastructure projects, it features immersive 3D/WebGL experiences that reflect the company's alignment with Saudi Vision 2030.",
    "thumbnail": "/work-images/medad.webp",
    "images": [
      "/work-images/medad.webp",
      "/work-images/medad2.webp"
    ],
    "stack": [
      "React 18",
      "TypeScript",
    ...
    "type": "Web experience",
    "summary": "A premium, highly interactive corporate web platform for a leading contracting company in Saudi Arabia. Built to showcase civil engineering capabilities and large-scale infrastructure projects, it features immersive 3D/WebGL experiences that reflect the company's alignment with Saudi Vision 2030.",
    "scope": "React 18, TypeScript",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "wide",
    ...
    "detailIntro": "A premium, highly interactive corporate web platform for a leading contracting company in Saudi Arabia. Built to showcase civil engineering capabilities and large-scale infrastructure projects, it features immersive 3D/WebGL experiences that reflect the company's alignment with Saudi Vision 2030.",
    "challenge": "My Role & Implementation: I built the entire front-end of this corporate platform from scratch using React 18 and TypeScript. My primary focus was on creating a premium, high-performance user experience, integrating complex Three.js and GSAP animations while ensuring the site maintains exceptional loading speeds and responsiveness.",
    "build": "Target Audience: Clients and partners seeking cutting-edge civil engineering and large-scale infrastructure services within the Kingdom of Saudi Arabia.",
    "impact": "Target Audience: Clients and partners seeking cutting-edge civil engineering and large-scale infrastructure services within the Kingdom of Saudi Arabia.",
    "modules": [
      "React 18",
      "TypeScript",
      "Vite",
  ...
  },
  {
    ...
    "description": "An immersive, cross-platform Augmented Reality (AR) experience that allows users to view high-fidelity 3D models of food dishes, furniture, and anatomy directly from their web browser. Built from scratch, focusing on high-performance 3D rendering.",
    "thumbnail": "/work-images/ar.webp",
    "images": [
      "/work-images/ar.webp",
      "/work-images/ar2.webp"
    ],
    "stack": [
      "React 18",
      "TypeScript",
    ...
    "type": "Digital product",
    "summary": "An immersive, cross-platform Augmented Reality (AR) experience that allows users to view high-fidelity 3D models of food dishes, furniture, and anatomy directly from their web browser. Built from scratch, focusing on high-performance 3D rendering.",
    "scope": "React 18, TypeScript",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "side",
    ...
    "detailIntro": "An immersive, cross-platform Augmented Reality (AR) experience that allows users to view high-fidelity 3D models of food dishes, furniture, and anatomy directly from their web browser. Built from scratch, focusing on high-performance 3D rendering.",
    "challenge": "My Role & Technical Approach: I built the entire front-end of this project from scratch. Beyond the complex 3D integration, I focused heavily on performance and SEO, successfully achieving a perfect 100 score on Google Lighthouse. I optimized the model assets (.glb, .usdz, and .webp) and established a seamless bridge between vanilla web components and the React ecosystem.",
    "build": "Target Audience: Restaurants, furniture retainers, and businesses seeking to elevate customer engagement via an immersive 3D/AR catalog.",
    "impact": "Target Audience: Restaurants, furniture retainers, and businesses seeking to elevate customer engagement via an immersive 3D/AR catalog.",
    "modules": [
      "React 18",
      "TypeScript",
      "Vite",
  ...
  },
  {
    ...
    "description": "Kemedar is a secure, comprehensive, and global real estate platform that revolutionizes how people buy and rent properties across the world. Born out of a real-life struggle with fraudulent agents and localized platforms, Kemedar organizes and secures the entire real estate process, eliminating borders, language barriers, and security risks.",
    "thumbnail": "/work-images/kemedar.webp",
    "images": [
      "/work-images/kemedar.webp"
    ],
    "stack": [
      "Laravel",
      "Blade Templates",
    ...
    "type": "Backend platform",
    "summary": "Kemedar is a secure, comprehensive, and global real estate platform that revolutionizes how people buy and rent properties across the world. Born out of a real-life struggle with fraudulent agents and localized platforms, Kemedar organizes and secures the entire real estate process, eliminating borders, language barriers, and security risks.",
    ...
    "detailIntro": "Kemedar is a secure, comprehensive, and global real estate platform that revolutionizes how people buy and rent properties across the world. Born out of a real-life struggle with fraudulent agents and localized platforms, Kemedar organizes and secures the entire real estate process, eliminating borders, language barriers, and security risks.",
    "challenge": "Key Technical Features: - Microservices Architecture for high scalability. - MongoDB for managing complex and large-scale property data. - API Gateway with JWT Authentication for secure access. - Achieved a 40% improvement in overall response times. - Fully containerized deployment using Docker and Nginx.",
    "build": "My Role & Technical Focus: Working as a Backend Developer within a large engineering team, I specialized in Laravel-side development. My primary mission was to modernize the platform by refactoring ancient legacy code, decoupling \"spaghetti\" logic into clean, scalable microservices, and optimizing data flow between the Laravel core and MongoDB.",
    "impact": "Challenges & Solutions: A major challenge in this project was navigating and modernizing an extensive, aging legacy codebase that had grown over five years. The system contained heavily entangled sections-often referred to as \"spaghetti code\"-making it incredibly difficult to edit or scale without breaking existing features. My focus was on aggressively refactoring these critical bottlenecks. By dissecting the legacy logic and establishing clean, microservices-oriented boundaries, I successfully reduced technical debt, stabilized the architecture, and significantly improved the maintainability of the codebase for the entire team.",
    "modules": [
      "Laravel",
      "Blade Templates",
      "MongoDB",
  ...
  },
  {
    ...
    "team": "Product, engineering, delivery",
    "headline": "3Dentix",
    "detailIntro": "3Dentix is a multilingual dental website available in English, French, and Spanish. It features four main pages: Home, About, Prices, and Contact. I received the UI from my team and handled the full implementation, including building the project, adding animations, and ensuring full responsiveness across devices.",
    "challenge": "My Role: I received the UI from my team and built the entire project, implementing the design, adding animations, and ensuring the site is fully responsive.",
    "build": "Target Audience: Dental clients and visitors seeking information and services in multiple languages.",
    "impact": "Target Audience: Dental clients and visitors seeking information and services in multiple languages.",
    "modules": [
      "React",
      "Tailwindcss",
      "Multilingual",
  ...
  },
  {
    ...
    "type": "Web experience",
    "summary": "Polrais Marine is a corporate website for a marine company specializing in building ships locally and exporting them worldwide. The site is designed and developed using React, with a strong focus on performance, SEO, and accessibility, achieving a perfect score on Google Insights. I handled the full setup, including deployment and domain acquisition.",
    "scope": "React, Tailwindcss",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "detailIntro": "Polrais Marine is a corporate website for a marine company specializing in building ships locally and exporting them worldwide. The site is designed and developed using React, with a strong focus on performance, SEO, and accessibility, achieving a perfect score on Google Insights. I handled the full setup, including deployment and domain acquisition.",
    "challenge": "My Role: I was responsible for the entire project lifecycle: design, development, performance optimization, SEO, accessibility, deployment, and domain setup.",
    "build": "Target Audience: International clients and partners seeking reliable shipbuilding and export services.",
    "impact": "Target Audience: International clients and partners seeking reliable shipbuilding and export services.",
    "modules": [
      "React",
      "Tailwindcss",
      "SEO",
  ...
  },
  {
    ...
    "description": "Nourtha-Tech V2 is a professional portfolio website for a Saudi tech company, featuring 8 distinct pages that highlight the company's services, solutions, and vision. The site is fully responsive and supports both Arabic and English localization.",
    "thumbnail": "/work-images/noutha-techv2.png",
    "images": [
      "/work-images/noutha-techv2-2.png",
      "/work-images/noutha-techv2.png"
    ],
    "stack": [
      "React",
      "Tailwindcss"
    ...
    "type": "Web experience",
    "summary": "Nourtha-Tech V2 is a professional portfolio website for a Saudi tech company, featuring 8 distinct pages that highlight the company's services, solutions, and vision. The site is fully responsive and supports both Arabic and English localization.",
    "scope": "React, Tailwindcss",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "detailIntro": "Nourtha-Tech V2 is a professional portfolio website for a Saudi tech company, featuring 8 distinct pages that highlight the company's services, solutions, and vision. The site is fully responsive and supports both Arabic and English localization.",
    "challenge": "My Role: I built the entire project from scratch, handling design, development, and deployment using React and Tailwind CSS.",
    "build": "Target Audience: Clients and partners seeking innovative tech solutions in Saudi Arabia.",
    "impact": "Target Audience: Clients and partners seeking innovative tech solutions in Saudi Arabia.",
    "modules": [
      "React",
      "Tailwindcss"
    ],
  ...
  },
  {
    ...
    "description": "Nourtha-Tech is a cutting-edge landing page designed for a leading tech company in Saudi Arabia. Built entirely from scratch, it showcases the company's innovative solutions, services, and vision. The website features a modern, responsive design with full localization support, ensuring accessibility for both Arabic and English-speaking audiences. Developed using React-Vite and Tailwind CSS, it delivers a seamless user experience and highlights the company's commitment to technological excellence.",
    "thumbnail": "/work-images/noutha-tech.png",
    "images": [
      "/work-images/noutha-tech.png",
      "/work-images/noutha-tech2.png"
    ],
    "stack": [
      "React",
      "AOS",
    ...
    "client": "Nourtha-Tech",
    "type": "Web experience",
    "summary": "Nourtha-Tech is a cutting-edge landing page designed for a leading tech company in Saudi Arabia. Built entirely from scratch, it showcases the company's innovative solutions, services, and vision. The website features a modern, responsive design with full localization support, ensuring accessibility for both Arabic and English-speaking audiences. Developed using React-Vite and Tailwind CSS, it delivers a seamless user experience and highlights the company's commitment to technological excellence.",
    "scope": "React, AOS",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "detailIntro": "Nourtha-Tech is a cutting-edge landing page designed for a leading tech company in Saudi Arabia. Built entirely from scratch, it showcases the company's innovative solutions, services, and vision. The website features a modern, responsive design with full localization support, ensuring accessibility for both Arabic and English-speaking audiences. Developed using React-Vite and Tailwind CSS, it delivers a seamless user experience and highlights the company's commitment to technological excellence.",
    "challenge": "Key Features: - Fully responsive design optimized for all devices. - Multilingual support for Arabic and English. - Integrated email system for seamless communication. - Built with React-Vite and Tailwind CSS for performance and scalability. - Represents the company's innovative approach to technology in Saudi Arabia.",
    "build": "Key Features: - Fully responsive design optimized for all devices. - Multilingual support for Arabic and English. - Integrated email system for seamless communication. - Built with React-Vite and Tailwind CSS for performance and scalability. - Represents the company's innovative approach to technology in Saudi Arabia.",
    "impact": "Key Features: - Fully responsive design optimized for all devices. - Multilingual support for Arabic and English. - Integrated email system for seamless communication. - Built with React-Vite and Tailwind CSS for performance and scalability. - Represents the company's innovative approach to technology in Saudi Arabia.",
    "modules": [
      "React",
      "AOS",
      "Tailwindcss"
  ...
  },
  {
    ...
    "description": "Fanzvar is a comprehensive platform that brings together social, entertainment, business, development, and services for local, regional, and global sports fans - with a special focus on football enthusiasts from different clubs and nations worldwide.",
    "thumbnail": "/work-images/fanvarl.png",
    "images": [
      "/work-images/fanzvar.jpg",
      "/work-images/fanvarl.png"
    ],
    "stack": [
      "PHP",
      "Laravel",
    ...
    "client": "Fanzvar",
    "type": "Backend platform",
    "summary": "Fanzvar is a comprehensive platform that brings together social, entertainment, business, development, and services for local, regional, and global sports fans - with a special focus on football enthusiasts from different clubs and nations worldwide.",
    "scope": "PHP, Laravel",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "wide",
    ...
    "team": "Product, engineering, delivery",
    "headline": "Fanzvar",
    "detailIntro": "Fanzvar is a comprehensive platform that brings together social, entertainment, business, development, and services for local, regional, and global sports fans - with a special focus on football enthusiasts from different clubs and nations worldwide.",
    "challenge": "My Role: I developed key core features including the competitions module, reels (media sharing), and the real-time chatting system. I also implemented JWT-based authentication for secure API access, built the full admin panel using Filament, and integrated notification systems for both users and admins.",
    "build": "Target Audience: Sports fans, contractors, consultants, project managers, and administrative teams seeking an all-in-one platform to manage communities, communication, and operational workflows.",
    "impact": "Challenges and Solutions: Handling multilingual content while maintaining an intuitive UX was a major challenge. I developed a dynamic language switching system with seamless localization for both frontend and admin sections. Real-time chat and notification delivery were implemented using Laravel Reverb and WebSockets, ensuring smooth cross-region communication. To solve timezone-related attendance recording issues, I standardized time handling based on user location and server synchronization.",
    "modules": [
      "PHP",
      "Laravel",
      "Filament",
  ...
  },
  {
    ...
    "client": "Inomhub",
    "type": "Web experience",
    "summary": "Inomhub is the official landing page for a parent company that aligns and connects multiple businesses under one unified brand. Built using PHP and Bootstrap, the website presents a professional and responsive interface, showcasing the group's vision and services. It includes full localization support and an integrated email system.",
    "scope": "PHP, AOS",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "side",
    ...
    "team": "Product, engineering, delivery",
    "headline": "Inomhub",
    "detailIntro": "Inomhub is the official landing page for a parent company that aligns and connects multiple businesses under one unified brand. Built using PHP and Bootstrap, the website presents a professional and responsive interface, showcasing the group's vision and services. It includes full localization support and an integrated email system.",
    "challenge": "My Role: I was responsible for the complete design, development, deployment, and infrastructure setup of the website. This included creating the UI/UX, implementing multilingual support, configuring the email server, and managing deployment.",
    "build": "Target Audience: Business stakeholders, partners, and clients seeking to understand and engage with the group of companies under Inomhub.",
    "impact": "Challenges and Solutions: Ensuring clean architecture, smooth deployment, and localization for multiple languages was essential. I addressed this by using lightweight PHP for the backend, Bootstrap for responsive design, and proper server configuration for both email and multilingual routing.",
    "modules": [
      "PHP",
      "AOS",
      "Bootstrap"
  ...
  },
  {
    ...
    "description": "Kenz is a powerful, multi-role contractor and consultant management system tailored for large-scale operational control. The system includes multi-user access, real-time chat, multilingual support, employee and content center management, ticketing, attendance, debt tracking, and more. Built with responsiveness and scalability in mind, it ensures a seamless experience across devices and user roles.",
    "thumbnail": "/work-images/thumnail.png",
    "images": [
      "/work-images/chat-filament.png",
      "/work-images/filament.png"
    ],
    "stack": [
      "PHP",
      "Filament",
    ...
    "type": "Backend platform",
    "summary": "Kenz is a powerful, multi-role contractor and consultant management system tailored for large-scale operational control. The system includes multi-user access, real-time chat, multilingual support, employee and content center management, ticketing, attendance, debt tracking, and more. Built with responsiveness and scalability in mind, it ensures a seamless experience across devices and user roles.",
    "scope": "PHP, Filament",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "detailIntro": "Kenz is a powerful, multi-role contractor and consultant management system tailored for large-scale operational control. The system includes multi-user access, real-time chat, multilingual support, employee and content center management, ticketing, attendance, debt tracking, and more. Built with responsiveness and scalability in mind, it ensures a seamless experience across devices and user roles.",
    "challenge": "My Role: I developed the complete system architecture and implementation-from designing the database structure and user roles to integrating multilingual support and real-time features.",
    "build": "Target Audience: Contractors, consultants, project managers, and administrative teams seeking a robust platform to manage teams, tasks, and communication in one place.",
    "impact": "Challenges and Solutions: Managing multilingual content while keeping the UI intuitive was challenging. I implemented a dynamic language switcher and content localization for all user-facing and admin sections. Real-time communication was achieved using Laravel Reverb for WebSocket integration. I also tackled timezone-related attendance issues to ensure accurate tracking across regions.",
    "modules": [
      "PHP",
      "Filament",
      "LiveWire",
  ...
  },
  {
    ...
    "slug": "cslf",
    "href": "https://cslf.sa",
    "description": "Conflict Solution is a professional portfolio website designed for a law company. The website features eight distinct pages that showcase the firm's services and expertise. Built with responsiveness in mind, it ensures a seamless browsing experience across devices.",
    "thumbnail": "/work-images/78.jpeg",
    "images": [
      "/work-images/78.jpeg",
      "/work-images/cslf2.png"
    ],
    "stack": [
      "ReactJs",
      "AOS",
    ...
    "type": "Web experience",
    "summary": "Conflict Solution is a professional portfolio website designed for a law company. The website features eight distinct pages that showcase the firm's services and expertise. Built with responsiveness in mind, it ensures a seamless browsing experience across devices.",
    "scope": "ReactJs, AOS",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "detailIntro": "Conflict Solution is a professional portfolio website designed for a law company. The website features eight distinct pages that showcase the firm's services and expertise. Built with responsiveness in mind, it ensures a seamless browsing experience across devices.",
    "challenge": "My Role: I developed the entire project from scratch, handling the design, coding, and deployment.",
    "build": "Target Audience: Clients seeking legal services and information about the law firm' expertise.",
    "impact": "Challenges and Solutions: During development, I encountered browser compatibility issues and challenges with CSS not rendering properly on the client's phone. Using my experience, I resolved these issues to ensure a flawless user experience.",
    "modules": [
      "ReactJs",
      "AOS",
      "CSS"
  ...
  },
  {
    ...
    "description": "Inovent is a website designed for a virtual events platform. It leverages virtual reality (VR) and Unity, allowing users to navigate with a keyboard or VR headset and create immersive environments. The platform enhances event engagement by providing an interactive and dynamic experience for attendees.",
    "thumbnail": "/work-images/inovent.png",
    "images": [
      "/work-images/inovent.png",
      "/work-images/inovent1.png"
    ],
    "stack": [
      "ReactJs Vite",
      "AOS",
    ...
    "client": "Inovent",
    "type": "Web experience",
    "summary": "Inovent is a website designed for a virtual events platform. It leverages virtual reality (VR) and Unity, allowing users to navigate with a keyboard or VR headset and create immersive environments. The platform enhances event engagement by providing an interactive and dynamic experience for attendees.",
    ...
    "team": "Product, engineering, delivery",
    "headline": "Inovent",
    "detailIntro": "Inovent is a website designed for a virtual events platform. It leverages virtual reality (VR) and Unity, allowing users to navigate with a keyboard or VR headset and create immersive environments. The platform enhances event engagement by providing an interactive and dynamic experience for attendees.",
    "challenge": "My Role: I developed the entire front-end of the project, handling UI design, interactivity, and responsiveness.",
    "build": "Target Audience: Event organizers and attendees looking for an immersive virtual event experience.",
    "impact": "Challenges and Solutions: Ensuring smooth performance and responsiveness across various devices was a key challenge. By optimizing assets and leveraging efficient rendering techniques, I provided a seamless user experience.",
    "modules": [
      "ReactJs Vite",
      "AOS",
      "CSS"
  ...
  },
  {
    ...
    "images": [
      "/work-images/aboutseller.png",
      "/work-images/seller-22.png"
    ],
    "stack": [
      "Next",
      "Type Script",
    ...
    "type": "Commerce system",
    "summary": "Out Seller is a modern, responsive landing page designed to showcase the Outsellers brand. It features a clean layout with sections for hero, services, about, and contact, all optimized for a professional online presence.",
    ...
    "detailIntro": "Out Seller is a modern, responsive landing page designed to showcase the Outsellers brand. It features a clean layout with sections for hero, services, about, and contact, all optimized for a professional online presence.",
    "challenge": "My Role: I designed and built the entire landing page from scratch, focusing on clean UI, responsive structure, and subtle scroll-based animations to keep the user engaged.",
    "build": "Target Audience: Businesses and clients looking to understand the Outsellers brand and get in touch through a professional online presence.",
    "impact": "Challenges & Solutions: One challenge was achieving a consistent design across different browsers and screen sizes. I utilized flexible grid layouts and tested responsiveness thoroughly to ensure pixel-perfect design everywhere.",
    "modules": [
      "Next",
      "Type Script",
      "Tailwindcss"
  ...
  },
  {
    ...
    "description": "Inom-Techs is a modern company profile website for a programming and marketing firm, featuring dynamic animations, localization with cookies, and dark mode support for an enhanced user experience.",
    "thumbnail": "/work-images/inom.png",
    "images": [
      "/work-images/inom.png",
      "/work-images/inom1.png"
    ],
    "stack": [
      "Nextjs",
      "Tailwindcss"
    ...
    "client": "Inom Techs",
    "type": "Web experience",
    "summary": "Inom-Techs is a modern company profile website for a programming and marketing firm, featuring dynamic animations, localization with cookies, and dark mode support for an enhanced user experience.",
    ...
    "team": "Product, engineering, delivery",
    "headline": "Inom Techs",
    "detailIntro": "Inom-Techs is a modern company profile website for a programming and marketing firm, featuring dynamic animations, localization with cookies, and dark mode support for an enhanced user experience.",
    "challenge": "My Role: I handled the entire project from design to deployment, ensuring a flawless and functional user interface and experience.",
    "build": "Target Audience: Consumers and businesses looking for programming and marketing services.",
    "impact": "Target Audience: Consumers and businesses looking for programming and marketing services.",
    "modules": [
      "Nextjs",
      "Tailwindcss"
    ],
  ...
  },
  {
    ...
    "description": "Seller-tech is a professional portfolio website designed for a law company. The website features eight distinct pages that showcase the firm's services and expertise. Built with responsiveness in mind, it ensures a seamless browsing experience across devices.",
    "thumbnail": "/work-images/newseller1.png",
    "images": [
      "/work-images/newseller1.png",
      "/work-images/newseller2.png"
    ],
    "stack": [
      "Next",
      "Type Script",
    ...
    "client": "Seller-tech",
    "type": "Commerce system",
    "summary": "Seller-tech is a professional portfolio website designed for a law company. The website features eight distinct pages that showcase the firm's services and expertise. Built with responsiveness in mind, it ensures a seamless browsing experience across devices.",
    "scope": "Next, Type Script",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "wide",
    ...
    "detailIntro": "Seller-tech is a professional portfolio website designed for a law company. The website features eight distinct pages that showcase the firm's services and expertise. Built with responsiveness in mind, it ensures a seamless browsing experience across devices.",
    "challenge": "My Role: I designed and built the entire landing page from scratch, focusing on clean UI, responsive structure, and subtle scroll-based animations to keep the user engaged.",
    "build": "Target Audience: Businesses and clients looking to understand the Outsellers brand and get in touch through a professional online presence.",
    "impact": "Challenges & Solutions: One challenge was achieving a consistent design across different browsers and screen sizes. I utilized flexible grid layouts and tested responsiveness thoroughly to ensure pixel-perfect design everywhere.",
    "modules": [
  ...
  },
  {
    ...
    "description": "An eLearning platform with multiple user roles (Admin, Teacher, User). Teachers manage courses and grades, while Zoom integration supports live sessions.",
    "thumbnail": "/work-images/educhain.png",
    "images": [
      "/work-images/educhain.png",
      "/work-images/educhain2.png"
    ],
    "stack": [
      "Laravel",
      "Tailwindcss"
    ...
    "client": "Edu Chain",
    "type": "Backend platform",
    "summary": "An eLearning platform with multiple user roles (Admin, Teacher, User). Teachers manage courses and grades, while Zoom integration supports live sessions.",
    ...
    "team": "Product, engineering, delivery",
    "headline": "Edu Chain",
    "detailIntro": "An eLearning platform with multiple user roles (Admin, Teacher, User). Teachers manage courses and grades, while Zoom integration supports live sessions.",
    "challenge": "My Role: Designed and developed the eLearning platform, including user roles, permissions, teacher panel, Zoom integration, and financial reporting features.",
    "build": "Challenges & Solutions: Integrated Zoom API for seamless live sessions and handled large video uploads for recorded sessions. Optimized performance for real-time updates and financial reports.",
    "impact": "Outcome: A comprehensive eLearning platform with an intuitive teacher interface, live session capabilities, and powerful admin features for financial tracking and user management.",
    "modules": [
      "Laravel",
      "Tailwindcss"
    ],
  ...
  },
  {
    ...
    "description": "Out Seller is a feature-rich eCommerce platform built with Laravel and Tailwind CSS, offering advanced product management, user authentication, and a responsive design for an optimal shopping experience.",
    "thumbnail": "/work-images/outseller.png",
    "images": [
      "/work-images/outseller.png",
      "/work-images/outseller1.png"
    ],
    "stack": [
      "Laravel",
      "Tailwindcss"
    ...
    "client": "Out Seller",
    "type": "Backend platform",
    "summary": "Out Seller is a feature-rich eCommerce platform built with Laravel and Tailwind CSS, offering advanced product management, user authentication, and a responsive design for an optimal shopping experience.",
    "scope": "Laravel, Tailwindcss",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "team": "Product, engineering, delivery",
    "headline": "Out Seller",
    "detailIntro": "Out Seller is a feature-rich eCommerce platform built with Laravel and Tailwind CSS, offering advanced product management, user authentication, and a responsive design for an optimal shopping experience.",
    "challenge": "My Role: Developed the entire eCommerce platform, including user authentication, product management, and payment integration.",
    "build": "Challenges & Solutions: Handled performance issues with product comparisons and optimized payment flow for seamless transactions.",
    "impact": "Outcome: A feature-rich eCommerce site with robust product management, smooth user experience, and a responsive design.",
    "modules": [
      "Laravel",
      "Tailwindcss"
    ],
  ...
  },
  {
    ...
    "description": "Hunter is a sleek and modern landing page designed to facilitate the buying and selling of houses.",
    "thumbnail": "/work-images/hunter.png",
    "images": [
      "/work-images/hunter.png",
      "/work-images/hunter3.png"
    ],
    "stack": [
      "ReactJs",
      "Tailwindcss"
    ...
    "client": "Hunter",
    "type": "Web experience",
    "summary": "Hunter is a sleek and modern landing page designed to facilitate the buying and selling of houses.",
    ...
    "team": "Product, engineering, delivery",
    "headline": "Hunter",
    "detailIntro": "Hunter is a sleek and modern landing page designed to facilitate the buying and selling of houses.",
    "challenge": "My Role: I built this project entirely from scratch, handling everything from design to development.",
    "build": "Target Audience: The platform is designed for consumers looking to buy or sell homes effortlessly.",
    "impact": "Target Audience: The platform is designed for consumers looking to buy or sell homes effortlessly.",
    "modules": [
      "ReactJs",
      "Tailwindcss"
    ],
  ...
  },
  {
    ...
    "description": "The Online Games Site is a centralized platform where gamers can explore and download thousands of games from over 100 websites, all in one place. It streamlines the process of finding games by fetching data dynamically via APIs.",
    "thumbnail": "/work-images/game1.png",
    "images": [
      "/work-images/game1.png",
      "/work-images/game2.png"
    ],
    "stack": [
      "Java Script",
      "Restful API"
    ...
    "type": "Backend platform",
    "summary": "The Online Games Site is a centralized platform where gamers can explore and download thousands of games from over 100 websites, all in one place. It streamlines the process of finding games by fetching data dynamically via APIs.",
    ...
    "detailIntro": "The Online Games Site is a centralized platform where gamers can explore and download thousands of games from over 100 websites, all in one place. It streamlines the process of finding games by fetching data dynamically via APIs.",
    "challenge": "My Role: I built this project from scratch, handling everything from API integration to the website's design and development.",
    "build": "Target Audience: Gamers seeking a convenient and centralized hub for exploring and downloading games.",
    "impact": "Target Audience: Gamers seeking a convenient and centralized hub for exploring and downloading games.",
    "modules": [
      "Java Script",
      "Restful API"
    ],
  ...
  },
  {
    ...
    "description": "Spiro Spates is a vibrant portfolio website created for a local soda drinks company. The website showcases the brand's products and values through an engaging and modern design, enhanced with interactive animations.",
    "thumbnail": "/work-images/Spiro.png",
    "images": [
      "/work-images/Spiro.png",
      "/work-images/spiro1.png"
    ],
    "stack": [
      "JavaScript",
      "CSS",
      "custom mouse tracking animations."
    ],
    "sections": [
      {
        "title": "Details",
    ...
    "client": "Spiro Spates",
    "type": "Web experience",
    "summary": "Spiro Spates is a vibrant portfolio website created for a local soda drinks company. The website showcases the brand's products and values through an engaging and modern design, enhanced with interactive animations.",
    ...
    "detailIntro": "Spiro Spates is a vibrant portfolio website created for a local soda drinks company. The website showcases the brand's products and values through an engaging and modern design, enhanced with interactive animations.",
    "challenge": "My Role: I co-developed this project equally with my friend Assem , collaborating on both the design and development aspects.",
    "build": "Target Audience: All users, especially soda drink enthusiasts looking to learn more about the brand.",
    "impact": "Target Audience: All users, especially soda drink enthusiasts looking to learn more about the brand.",
    "modules": [
      "JavaScript",
      "CSS",
      "custom mouse tracking animations."
  ...
  },
  {
    ...
    "description": "A sleek and functional eCommerce platform featuring responsive design, user authentication, and seamless shopping experiences with real-time API integration.",
    "thumbnail": "/work-images/pro6.png",
    "images": [
      "/work-images/pro6.png"
    ],
    "stack": [
      "ReactJs",
      "Tailwindcss"
    ...
    "client": "Halaa-Bazaar",
    "type": "Backend platform",
    "summary": "A sleek and functional eCommerce platform featuring responsive design, user authentication, and seamless shopping experiences with real-time API integration.",
    "scope": "ReactJs, Tailwindcss",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "detailIntro": "A sleek and functional eCommerce platform featuring responsive design, user authentication, and seamless shopping experiences with real-time API integration.",
    "challenge": "My Role: Developed the app from scratch, including design, coding, and API integration, ensuring functionality and scalability.",
    "build": "Challenges & Solutions: Resolved API fetching issues and cross-browser CSS inconsistencies to deliver a smooth, responsive user experience.",
    "impact": "Outcome: A fully functional eCommerce app with a modern design and core shopping features tailored for online users.",
    "modules": [
      "ReactJs",
      "Tailwindcss"
    ],
  ...
  },
  {
    ...
    "description": "A dynamic eCommerce platform with user authentication, add-to-cart functionality, and a responsive design for a seamless shopping experience.",
    "thumbnail": "/work-images/66.jpg",
    "images": [
      "/work-images/66.jpg",
      "/work-images/ecommerce.png"
    ],
    "stack": [
      "React",
      "CSS"
    ...
    "client": "ShopWise",
    "type": "Commerce system",
    "summary": "A dynamic eCommerce platform with user authentication, add-to-cart functionality, and a responsive design for a seamless shopping experience.",
    "scope": "React, CSS",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "wide",
    ...
    "team": "Product, engineering, delivery",
    "headline": "ShopWise",
    "detailIntro": "A dynamic eCommerce platform with user authentication, add-to-cart functionality, and a responsive design for a seamless shopping experience.",
    "challenge": "My Role: Developed the app from scratch, including design, coding, and API integration, ensuring functionality and scalability.",
    "build": "Challenges & Solutions: Resolved API fetching issues and cross-browser CSS inconsistencies to deliver a smooth, responsive user experience.",
    "impact": "Outcome: A fully functional eCommerce app with a modern design and core shopping features tailored for online users.",
    "modules": [
  ...
  },
  {
    ...
    "description": "An eCommerce admin dashboard built with Laravel and Tailwind CSS, featuring category-product relationships and API export for efficient data management using MySQL.",
    "thumbnail": "/work-images/gamel1.png",
    "images": [
      "/work-images/gamel1.png",
      "/work-images/gamel2.png"
    ],
    "stack": [
      "Laravel",
      "Tailwindcss"
    ...
    "type": "Backend platform",
    "summary": "An eCommerce admin dashboard built with Laravel and Tailwind CSS, featuring category-product relationships and API export for efficient data management using MySQL.",
    "scope": "Laravel, Tailwindcss",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "side",
    ...
    "detailIntro": "An eCommerce admin dashboard built with Laravel and Tailwind CSS, featuring category-product relationships and API export for efficient data management using MySQL.",
    "challenge": "My Role: Designed and developed the system architecture, implemented database relationships, and created APIs to manage and expose the data.",
    "build": "Challenges & Solutions: Optimized database queries for performance and ensured secure API endpoints to maintain data integrity.",
    "impact": "Outcome: A robust admin dashboard allowing seamless management of eCommerce categories, sub-categories, and products, along with an API layer for external integrations.",
    "modules": [
      "Laravel",
      "Tailwindcss"
    ],
  ...
  },
  {
    ...
    "images": [
      "/work-images/kids.png",
      "/work-images/kids1.png"
    ],
    "stack": [
      "Nextjs",
      "Tailwindcss"
    ...
    "client": "our kids",
    "type": "Web experience",
    "summary": "A beautiful and comprehensive Tailwind CSS components library for building modern websites and applications.",
    "scope": "Nextjs, Tailwindcss",
    "outcome": "Live project",
    "visual": "portfolio",
    "span": "half",
    ...
    "team": "Product, engineering, delivery",
    "headline": "our kids",
    "detailIntro": "A beautiful and comprehensive Tailwind CSS components library for building modern websites and applications.",
    "challenge": "Exercitation pariatur enim occaecat adipisicing nostrud adipisicing Lorem tempor ullamco exercitation quis et dolor sint. Adipisicing sunt sit aute fugiat incididunt nostrud consequat proident fugiat id. Officia aliquip laborum labore eu culpa dolor reprehenderit eu ex enim reprehenderit. Cillum Lorem veniam eu magna exercitation. Reprehenderit adipisicing minim et officia enim et veniam Lorem excepteur velit adipisicing et Lorem magna.",
    "build": "Exercitation pariatur enim occaecat adipisicing nostrud adipisicing Lorem tempor ullamco exercitation quis et dolor sint. Adipisicing sunt sit aute fugiat incididunt nostrud consequat proident fugiat id. Officia aliquip laborum labore eu culpa dolor reprehenderit eu ex enim reprehenderit. Cillum Lorem veniam eu magna exercitation. Reprehenderit adipisicing minim et officia enim et veniam Lorem excepteur velit adipisicing et Lorem magna.",
    "impact": "Exercitation pariatur enim occaecat adipisicing nostrud adipisicing Lorem tempor ullamco exercitation quis et dolor sint. Adipisicing sunt sit aute fugiat incididunt nostrud consequat proident fugiat id. Officia aliquip laborum labore eu culpa dolor reprehenderit eu ex enim reprehenderit. Cillum Lorem veniam eu magna exercitation. Reprehenderit adipisicing minim et officia enim et veniam Lorem excepteur velit adipisicing et Lorem magna.",
    "modules": [
      "Nextjs",
      "Tailwindcss"
    ],
...
export const workItems: WorkItem[] = portfolioProjects.map((project) => ({
  ...project,
